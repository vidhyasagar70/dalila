...
export const DiamondTableRow: React.FC<DiamondTableRowProps> = ({
  ...
  const backgroundStyle = index % 2 === 1
  ...
  return (
    ...
    >
      ...
      <td className="text-[14px] text-gray-700" style={{ width: '60px', minWidth: '60px', maxWidth: '60px', whiteSpace: 'nowrap', border: 'none', margin: 0, padding: '4px 8px' }}>{diamond.CUT || 'N/A'}</td>
      <td className="text-[14px] text-gray-700" style={{ width: '70px', minWidth: '70px', maxWidth: '70px', whiteSpace: 'nowrap', border: 'none', margin: 0, padding: '4px 8px' }}>{diamond.POL || 'N/A'}</td>
      <td className="text-[14px] text-gray-700" style={{ width: '60px', minWidth: '60px', maxWidth: '60px', whiteSpace: 'nowrap', border: 'none', margin: 0, padding: '4px 8px' }}>{diamond.SYM || 'N/A'}</td>
      ...
      <td className="text-[14px] text-gray-700" style={{ width: '200px', minWidth: '200px', maxWidth: '200px', border: 'none', margin: 0, padding: '4px 8px' }} title={diamond.COMMENTS_1}>
        <div style={{ overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{diamond.COMMENTS_1 || 'N/A'}</div>
      </td>
      <td className="text-[14px] text-gray-700" style={{ width: '70px', minWidth: '70px', maxWidth: '70px', whiteSpace: 'nowrap', border: 'none', margin: 0, padding: '4px 8px' }}>{diamond.DEPTH_PER || 'N/A'}</td>
      <td className="text-[14px] text-gray-700" style={{ width: '70px', minWidth: '70px', maxWidth: '70px', whiteSpace: 'nowrap', border: 'none', margin: 0, padding: '4px 8px' }}>{diamond.TABLE_PER || 'N/A'}</td>
      <td className="text-[14px] text-gray-700" style={{ width: '70px', minWidth: '70px', maxWidth: '70px', whiteSpace: 'nowrap', border: 'none', margin: 0, padding: '4px 8px' }}>{diamond.LENGTH || 'N/A'}</td>
      <td className="text-[14px] text-gray-700" style={{ width: '70px', minWidth: '70px', maxWidth: '70px', whiteSpace: 'nowrap', border: 'none', margin: 0, padding: '4px 8px' }}>{diamond.WIDTH || 'N/A'}</td>
      <td className="text-[14px] text-gray-700" style={{ width: '70px', minWidth: '70px', maxWidth: '70px', whiteSpace: 'nowrap', border: 'none', margin: 0, padding: '4px 8px' }}>{diamond.DEPTH || 'N/A'}</td>
      <td className="text-[14px] text-gray-700" style={{ width: '140px', minWidth: '140px', maxWidth: '140px', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', border: 'none', margin: 0, padding: '4px 8px' }}>{diamond.KEY_TO_SYMBOLS || 'N/A'}</td>
      <td className="text-[14px] text-gray-700" style={{ width: '200px', minWidth: '200px', maxWidth: '200px', border: 'none', margin: 0, padding: '4px 8px' }} title={diamond.REPORT_COMMENTS}>
        <div style={{ overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{diamond.REPORT_COMMENTS || 'N/A'}</div>
      </td>
      <td className="text-[14px] text-gray-700" style={{ width: '110px', minWidth: '110px', maxWidth: '110px', whiteSpace: 'nowrap', border: 'none', margin: 0, padding: '4px 8px' }}>{diamond.CROWN_ANGLE || 'N/A'}</td>
      ...
      <td className="text-[14px] text-gray-700" style={{ width: '110px', minWidth: '110px', maxWidth: '110px', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', border: 'none', margin: 0, padding: '4px 8px' }}>
        {diamond.REPORT_DATE ? new Date(diamond.REPORT_DATE).toLocaleDateString() : 'N/A'}
      </td>
      <td className="text-[14px] text-gray-700" style={{ width: '80px', minWidth: '80px', maxWidth: '80px', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', border: 'none', margin: 0, padding: '4px 8px' }}>{diamond.TINGE || 'N/A'}</td>
    </tr>
  );
};
