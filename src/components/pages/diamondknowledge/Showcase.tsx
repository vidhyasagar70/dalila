        ...
        <div className="grid md:grid-cols-2 gap-16 items-center mb-32">
          ...
          <div>
            <div className="max-w-xl">
              <h4 className={`text-sm md:text-base uppercase tracking-widest text-gray-500 mb-4 font-medium ${playFair.className}`}>
                Introduction
              </h4>
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div>
            <div className="max-w-xl">
              ...
              <p className={`text-gray-600 leading-relaxed mb-8 text-[15px] md:text-base font-normal ${playFair.className}`}>
                Natural diamonds are created under extreme pressure and temperature conditions, deep below the Earth&apos;s surface. Over millions of years, these crystals travel upward through volcanic activity, eventually reaching the surface where they are mined and transformed into beautiful jewels.
              </p>
              <p className={`text-gray-600 leading-relaxed mb-8 text-[15px] md:text-base font-normal ${playFair.className}`}>
                Each diamond&apos;s journey — from mine to masterpiece — involves ethical sourcing, expert craftsmanship, and precise grading to ensure its authenticity and value.
              </p>
            </div>
          </div>
