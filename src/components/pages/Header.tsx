...
export default function Header() {
  ...
  if (!isLoggedIn) {
    ...
    rightSideItems = [{ href: "/inventory", label: "Inventory" }];
  } else {
    navigationItems = [
      { href: "/aboutUs", label: "About us" },
      { href: "/contact", label: "Contact Us" },
      ...
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center justify-end gap-2 xl:gap-3 flex-1">
            ...
            {/* Right Side Navigation Items as Buttons */}
          ...
          <div className="hidden md:flex lg:hidden items-center gap-2">
            ...
            {rightSideItems.map((item) => (
              <button
                ...
                className="py-1 px-3 text-xs text-white border border-[#c89e3a] hover:bg-[#c89e3a] hover:text-white transition-colors whitespace-nowrap"
              >
                {item.label.toUpperCase()}
              </button>
            ))}
