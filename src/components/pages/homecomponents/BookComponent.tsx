        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 lg:gap-8 items-center max-w-7xl mx-auto">
          ...
          >
            ...
            >
              ...
              collection reflects elegance and perfection. Each piece is crafted
              with care, ensuring beauty, rarity, and everlasting value.
              Experience luxury beyond imagination with us.
            </p>
