      ...
      <div className="w-full max-w-7xl mx-auto">
        <div className="grid grid-cols-2 gap-8 items-center">
          ...
          <div className="flex flex-col gap-1 mt-65">
            <h6
              className={`text-3xl md:text-4xl font-light leading-tight text-blue-600 ${playFair.className}`}
            >
              50+ years of family expertise
            </h6>
            <p
              className={`text-2xl md:text-3xl text-gray-800 font-light ${playFair.className}`}
            >
