  ...
  return (
    <div className="bg-white py-24">
      <div className="max-w-7xl mx-auto px-6 md:px-8 lg:px-12">
        <h1
          className={`text-4xl md:text-5xl lg:text-[3.5rem] font-normal text-center mb-20 text-gray-900 ${playFair.className}`}
        >
            ...
            <div className="space-y-8">
              ...
              <div className="flex gap-4">
                ...
                <div className="flex-1">
                  <p
                    className={`text-gray-600 text-base md:text-lg leading-relaxed ${playFair.className}`}
                  >
              ...
              <div className="flex gap-4">
                ...
                <div className="flex-1 pl-8">
                  <p
                    className={`text-gray-800 text-base md:text-lg leading-relaxed ${playFair.className}`}
                  >
                    <span className="font-semibold">
