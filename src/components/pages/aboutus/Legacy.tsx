    ...
    <div className="bg-gradient-to-b from-gray-50 to-white py-12 md:py-16 lg:py-20">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 lg:gap-8 items-stretch max-w-7xl mx-auto">
          ...
          >
            <h1 className={`text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-white mb-3 md:mb-4 leading-tight ${playFair.className}`}>
              Our Legacy
            </h1>
            
            <p className={`text-gray-300 text-xs sm:text-sm md:text-base leading-relaxed mb-3 md:mb-4 ${playFair.className}`}>
            ...
            <p className={`text-gray-300 text-xs sm:text-sm md:text-base leading-relaxed mb-4 md:mb-6 ${playFair.className}`}>
           ...
           <button className={`py-2 px-4 md:py-2.5 md:px-5 lg:px-6 text-xs sm:text-sm lg:text-base text-white border border-[#c89e3a] hover:bg-[#c89e3a] hover:text-white transition-colors whitespace-nowrap w-fit ${playFair.className}`}>
              CONTACT
            </button>
          </div>
