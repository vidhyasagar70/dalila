  ...
  const steps = [
    {
      ...
      description: 'Fill out our straightforward online form and provide any details you have about your diamonds or jewelry. It\'s quick, easy, and the first step toward getting the best value.',
    ...
    },
    {
      ...
      description: 'You can schedule a face-to-face evaluation at one of our trusted locations. If you prefer not to travel, we offer a safe, insured courier service to collect your diamonds from anywhere in Europe. Your valuable pieces are always in safe hands.',
    ...
    },
    {
      ...
      description: 'Our GIA-certified gemologists and gold specialists evaluate your diamonds and fine jewelry based on the 4Cs, current market conditions, and accurate pricing.',
        ...
        <div className="space-y-16 md:space-y-24">
          {steps.map((step, index) => (
            ...
            >
              ...
              <div className={`relative lg:absolute lg:top-1/2 lg:-translate-y-1/2 ${
