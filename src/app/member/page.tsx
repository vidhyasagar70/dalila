    ...
    const fetchPendingUsers = useCallback(async () => {
        try {
            ...
            if (response.success && response.data) {
                ...
                const pendingUsers = Array.isArray(response.data)
                    ? response.data
                    : [];

                const transformedUsers: ExtendedUser[] = pendingUsers.map(
                    (user) => ({
                        ...user,
                        id: user._id || user.id,
                        firstName:
                            user.customerData?.firstName || user.firstName,
            ...
            if (response.success && response.data) {
                ...
                const authorizedUsers: ExtendedUser[] = usersArray
                    ...
                    .map((user) => ({
                        ...
                        firstName:
                            user.firstName || user.customerData?.firstName,
